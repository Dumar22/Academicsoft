<?php
	...
	if(!empty($_POST))
	{
		...
		if(!empty($valor)){
			...
			if(is_numeric($valor)){
				$where = "WHERE Id_acudiente = $valor";
	...
	$sql = "SELECT * FROM acudiente $where";
			...
			<tbody>
			    <?php while($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
				    <tr>
						...
						<td><a href="#" data-href="eliminarAcudiente.php?Id_acudiente=<?php echo $row['Id_acudiente']; ?>" data-toggle="modal" data-target="#confirm-delete"><i class="fa-regular fa-trash"></i></a></td>
							</tr>
						<?php } ?>
			</tbody>
		</table>
