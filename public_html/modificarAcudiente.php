<?php
	...
	$Id_acudiente = $_GET['id'];
	$sql = "SELECT * FROM acudiente WHERE Id_acudiente = '$Id_acudiente'";
...
<li class="nav__submenu-item"> <a href="mostrarMateria2.php" style="color:#f9f5f5;">Actualizar</a></li>
    ...
    <div class="container">
<div class="container">
            <h2>Actualizar datos de los acudientes</h2>
            <h3>Digite los datos personales del acudiente</h3>
            <hr />
            <br />

    <table class="formulario" align="center">
        <form action="updateAcudiente.php" method="post" >
            <tr>
                <td>N.identificación: </td>
                <td>Nombres: </td>
             </tr>
            <tr>
                <td><input value="<?php echo $row['Id_acudiente']; ?>" type="text" name="Id_acudiente" placeholder="Ingrese el número de identificación" required onkeypress='return event.charCode >= 48 && event.charCode <= 57'></td>
                 <td><input value="<?php echo $row['Nombre']; ?>" type="search" name="Nombre" placeholder="Ingrese el nombre" required></td>
            ...
            <tr>
               ...
               <td><input  value="<?php echo $row['Apellido']; ?>" type="text" name="Apellido" placeholder="Ingrese el apellido" required></td>
