			    ...
			    <tbody>
			       <?php while($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
				      <tr>
						...
						<td><a href="#" data-href="eliminarGrado.php?id=<?php echo $row['Id_grado']; ?>" data-toggle="modal" data-target="#confirm-delete"><i class="fa-regular fa-trash"></i></a></td>
							</tr>
				   <?php } ?>
			    </tbody>
		     </table>
