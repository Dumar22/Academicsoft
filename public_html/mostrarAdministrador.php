			...
			<tbody>
			    <?php while($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
				    <tr>
						...
						<td><a href="#" data-href="eliminarAdministrador.php?id=<?php echo $row['Identificacion']; ?>" data-toggle="modal" data-target="#confirm-delete"><i class="fa-regular fa-trash"></i></a></td>
							</tr>
						<?php } ?>
			</tbody>
		</table>
