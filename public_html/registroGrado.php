     ...
     <body>
       <div class="container">
          ...
          <table class="formulario" align="center">
            <form action="registroGrado.php" method="post" >
              <tr>
                <td>Curso:</td>
              </tr>
              <tr>
                <td><input type="text" name="Curso" placeholder="Digite el curso" required></td>
              </tr>
              <table align="center">
                <tr>
...
if($_POST){
  ...
  $insertar="INSERT INTO Grado (Curso) VALUES ('$Curso')"; 
  ...
  if(!$resultado){
   //echo 'Error al Registrarse';   
    ...
    echo '
    <script>
    alert ("Grado registrado satisfactoriamente");
    window.location = "../registroGrado.php";
    </script>
    ';
  }
  mysqli_close($mysqli);
